...
![](https://huhexian.s3.bitiful.net/2024/01/02/5ca6c252473d4b81.webp)
...
![](https://huhexian.s3.bitiful.net/2024/01/02/02eaa64c92b4fb90.webp)

本来想专门写一篇文章介绍并分享这一款浏览器扩展，也是我在2023年用过的最棒的工具之一，今天碰上 ChatGPT，便一并聊聊吧。

[沉浸式翻译](https://immersivetranslate.com/)最早应该是在2022年12月出来的，当时还不支持使用 ChatGPT 的翻译服务，我便使用默认的必应翻译或者腾讯交互翻译，后来发现可以自己申请彩云小译的 API，便换成了彩云小译，翻译质量和水平也有所提升。
...
![](https://huhexian.s3.bitiful.net/2024/01/02/b7ce006881b8f9a1.gif)

直到支持使用 ChatGPT 的翻译服务，两者一起使用，翻译水平和质量有大幅提升。只需要在扩展设置中添加自己的 OpenAI API Key，就可以在扩展中使用 ChatGPT 的翻译服务。

![](https://huhexian.s3.bitiful.net/2024/01/02/aa485d7696852223.webp)
...
另外，最近在 GitHub 上 Fork 了 XiaowenZ 修改过的项目——[daily](https://github.com/huhexian/daily)，主要是利用 GitHub Actions，搭配各类 API，定时生成对应的信息，并发送到 Telegram 频道或群组。我在这个项目里添加了 Bing Create 的 cookie，以及每日诗词的 API，让 Bing Create 以每日诗词的内容为提示词，生成对应的图片，于是便有了下面的效果。

![](https://huhexian.s3.bitiful.net/2024/01/02/f811bd7a06a29150.webp) |![](https://huhexian.s3.bitiful.net/20240102215546.png)
---|---


## ChatGPT-Next-Web

![](https://huhexian.s3.bitiful.net/2024/01/02/02db1d0b428792ce.webp)
...
正好有 [ChatGPT-Next-Web](https://github.com/ChatGPTNextWeb/ChatGPT-Next-Web) 项目，免费部署，填入自己的 OpenAI API Key，即可与之对话，而且还内置了海量的 prompts，将其打造成各种身份，用于各种方面，比如学术论文、创意写作、数据分析等，再或者是让它模仿小红书笔记的风格，以特定产品为描述对象，生成小红书风格的内容……
...
朋友最近在做一个代理服务——[AIGC API](https://aigcapi.io/)（aigcapi.io），低于 OpenAI 官方价格，却可以使用 GPT-4、DALL-E-3、Claude 2等模型的 API Key，虽然我不知道这是如何做到的，但觉得非常神奇，1美元额度的 API Key，在他那里只需要2元人民币，官方价格居然是他的3.6倍。

![](https://huhexian.s3.bitiful.net/2024/01/02/3ad63e29c9722f2f.webp)


![](https://huhexian.s3.bitiful.net/2024/01/02/56a42f98518ebb3b955d0467cae1a612.webp)
...
然后偶尔使用 DALL-E-3 文生图模型，让 AI 画出一些古诗词中的景色和场景，用了大半个月，我的感受是：太耐用，用不完，根本用不完。20美元不到，按照朋友提供的价格，折合人民币40元不到，但如果按照 OpenAI 官方的定价，就得上百块钱。

![](https://huhexian.s3.bitiful.net/2024/01/02/4baa4a6453ec63cf.webp)
...
最后我的选择还是跟随自己的需求，不要一拥而上，ChatGPT、[Perplexity](https://yinji.org/5169.html)、Bing Create 足够我使用很久很久，除非我产生了新的需求。